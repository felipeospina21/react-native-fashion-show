...
export default function AssetCard({ assetData:{thumb, image, price, id}, setAsset, assetType, characterGender }: AssetCardProps) {
  const [useBalance, buyAsset, assetsOwned, balance] = useStore((state)=>[state.useBalance, state.buyAsset, state.assetsOwned, state.balance])  
